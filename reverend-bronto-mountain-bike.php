...
<title>Bronto MTB Co. - Reverend - 29er Geared Mountain Hardtail</title>
<link rel="icon" href="favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
<link href="css/Bronto-Style.css" rel="stylesheet" type="text/css" />
<link href="css/popup-Style.css" rel="stylesheet" type="text/css" media="screen"/>
<script type="text/javascript" src="js/jquery-1.4.1.min.js"></script>
<script src="jQuery-popup/popup.js" type="text/javascript"></script>
<script src="js/popup-v2.js" type="text/javascript"></script>
<script type="text/javascript" src="js/jquery-rev-geo-xml-parse.js"></script>
...
<div id="wrapper">
  ...
  <div id="mainContent_container">
    <div id="mainContent">
      <div id="divleft"><a href="_index.php"><img src="images/BRONTO_Logo_main.gif" alt="Bronto Bikes" /></a>
        <?php include 'includes/bike-model-menu-leftpanel.php' ?>
      </div>
      <div id="divright">
        <?php include 'includes/bike-maincontent-rightpanel.php' ?>
      </div>
    </div>
 ...
 <?php include 'popups/popup-color-options.php' ?>
 <?php include 'popups/popup-rev-geometry.php' ?>
